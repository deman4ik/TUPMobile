...
namespace TUPMobile.Droid.Renderers
{
    public class SocialLoginPageRenderer : PageRenderer
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Page> e)
        {
            ...
            var auth = new OAuth2Authenticator(clientId, // your OAuth2 client id
                clientSecret, scope, // the scopes for the particular API you're accessing, delimited by "+" symbols
